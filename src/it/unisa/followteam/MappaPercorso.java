...
public class MappaPercorso extends Fragment {
        ...
        public void onResume() {
                ...
                if (map == null) {
                    ...
                    final Double latitudine = Double.parseDouble(args.getString(MyDatabase.StadioMetaData.STADIO_LAT));
                    final Double longitudine =Double.parseDouble(args.getString(MyDatabase.StadioMetaData.STADIO_LONG));
                    LatLng coordinateStadio =new LatLng(latitudine, longitudine);
                    gps = new GPSTracker(getActivity().getApplicationContext());
                    
                   	myLat = gps.getLatitude();
                   	myLong = gps.getLongitude();
                   	line= map.addPolyline(new PolylineOptions().geodesic(true).add(new LatLng(myLat, myLong), coordinateStadio).width(5).color(Color.RED));
                    ...
                    puntatore =map.addMarker(new MarkerOptions().position(coordinateStadio));
                    ...
                    map.setOnMarkerClickListener(new OnMarkerClickListener() {
						...
						public boolean onMarkerClick(Marker marker) {
								...
								url = "http://maps.google.com/maps?f=d&daddr="+latitudine+","+longitudine+"&mode=driving";
