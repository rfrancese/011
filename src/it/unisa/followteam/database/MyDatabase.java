...
public class MyDatabase {  
        ...
        private class DbHelper extends SQLiteOpenHelper { 
            ...
            public void onCreate(SQLiteDatabase _db) { //solo quando il db viene creato, creiamo la tabella
                    ...
                    load(_db, new InputStreamReader(this.getClass().getResourceAsStream("stadi.csv")), StadioMetaData.STADIO_TITLE_TABLE);
                    load(_db, new InputStreamReader(this.getClass().getResourceAsStream("giornate.csv")), GiornataMetaData.GIORNATA_TITLE_TABLE);
                    load(_db, new InputStreamReader(this.getClass().getResourceAsStream("partite.csv")), PartiteMetaData.PARTITA_TITLE_TABLE);
        ...
        private void load(SQLiteDatabase db, InputStreamReader in, String titolo_tabella) {
            ...
            try {
                    ...
                    while ( (line = reader.readLine()) != null ) {
                    		...
                    		case "stadio":
                    			db.insert(titolo_tabella, null, getContentValuesStadio(line));
                    			break;
                    		
                    		case "partita":
                    			db.insert(titolo_tabella, null, getContentValuesPartita(line));
                    			break;
                    		case "giornata":
                    			db.insert(titolo_tabella, null, getContentValuesGiornata(line));
                    			break;
                    		default:
        ...
        private static ContentValues getContentValuesPartita(String value) {
            ...
            result.put(PartiteMetaData.PARTITA_SQ_OSPITE, stringTokenizer.nextToken());
            result.put(PartiteMetaData.PARTITA_IDGIORNATA, stringTokenizer.nextToken());
            return result;
        }
        ...
        public Cursor fetchStadio(){ //metodo per fare la query di tutti i dati
                return mDb.query(StadioMetaData.STADIO_TITLE_TABLE, null,null,null,null,null,null);               
        }
        
        public Cursor fetchGiornata(){ //metodo per fare la query di tutti i dati
            return mDb.query(GiornataMetaData.GIORNATA_TITLE_TABLE, null,null,null,null,null,null);               
        }
        ...
        private static final String GIORNATA_TABLE_CREATE="CREATE TABLE IF NOT EXISTS "
        				...
        				+ GiornataMetaData.GIORNATA_ID+ " INTEGER PRIMARY KEY,"
        ...
        private static final String PARTITA_TABLE_CREATE="CREATE TABLE IF NOT EXISTS "
        				...
        				+ PartiteMetaData.PARTITA_ID+" INTEGER PRIMARY KEY AUTOINCREMENT,"
        				+ PartiteMetaData.PARTITA_SQ_CASA+ " TEXT,"
        				+ PartiteMetaData.PARTITA_SQ_OSPITE+ " TEXT,"
        				+ PartiteMetaData.PARTITA_IDGIORNATA+" INTEGER, FOREIGN KEY ("
        				+ PartiteMetaData.PARTITA_IDGIORNATA+") REFERENCES "
        				+ GiornataMetaData.GIORNATA_TITLE_TABLE+"("+ GiornataMetaData.GIORNATA_ID+")"
        				+ ");";
